...
### [Blog 3 - Artera và bài toán ứng dụng AWS để tăng tốc chẩn đoán ung thư tuyến tiền liệt](3.3-Blog3/) 
Bài blog này giới thiệu cách **Artera** xây dựng nền tảng AI phân tích ảnh sinh thiết trên AWS nhằm hỗ trợ chẩn đoán **ung thư tuyến tiền liệt** nhanh và chính xác hơn. Bạn sẽ tìm hiểu cách kết hợp **Amazon ECS, Amazon EKS, Amazon EFS, Amazon RDS, Amazon S3, AWS Global Accelerator và Application Load Balancer** để xử lý khối lượng lớn dữ liệu ảnh y tế, đồng thời đảm bảo khả năng mở rộng, bảo mật và tuân thủ các yêu cầu lưu trữ dữ liệu theo từng khu vực.